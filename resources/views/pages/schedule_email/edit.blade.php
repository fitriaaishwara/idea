...
@push('js')
    ...
    <script type="text/javascript">
        $(function() {
            ...
            let arrScope = [0];
            let schedule_mail_id = $('.schedule_mail_id').val();
            scope();
            ...
            $('#saveBtn').click(function(e) {
                ...
                if (isValid) {
                    ...
                    if (is_html == 1) {
                        let url = "{{ route('schedule-mail/update') }}";
                        $('#saveBtn').text('Save...');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        $.each(response.data.schedule_email_scopes, function(key, value) {
                            ...
                            arrScope.push(String(value.scope_id));
                        });
                        ...
                        if (response.data.is_html) {
                            $('#body_html').val(response.data.body);
                        } else {
