...
@section('title') @lang('Meeting Project') @endsection
...
@slot('title') Meeting Project @endslot
@endcomponent
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <a  href="{{ url('monitoring-project-meeting/create/' . $id) }}" class="btn btn-dark waves-effect waves-light btn-sm m-1" id="addNew" name="addNew"><i class="mdi mdi-plus-circle mr-1"></i> Meeting Project</a>
            ...
            <div class="card-footer">
                <a href="{{ route('monitoring-project') }}" class="btn btn-dark waves-effect waves-light btn-sm"><i class="mdi mdi-arrow-left"></i> Back</a>
            </div>
        </div>
    </div> <!-- end col -->
</div> <!-- end row -->
    ...
    <script type="text/javascript">
        ...
        let monitoringProjectMeetingTable = $('#monitoringProjectMeetingTable').DataTable({
            ...
            },
            {
                ...
                let urlEdit = "{{ route('monitoring-project-meeting/edit', ['id' => ':id']) }}";
                ...
                let btnEdit = '<a href="' + urlEdit + '" name="btnEdit" type="button" class="btn btn-warning btn-sm m-1" data-toggle="tooltip" data-placement="top" title="Edit"><i class="fa fa-edit"></i></a>';
                let btnDelete = '<button name="btnDelete" data-id="' + data + '" type="button" class="btn btn-danger btn-sm btnDelete m-1" data-toggle="tooltip" data-placement="top" title="Delete"><i class="fa fa-trash"></i></button>';
                ...
                return btnDetail+btnEdit+btnDelete+btnDownload;
                },
            },
            ]
        });
        function reloadTable() {
            monitoringProjectMeetingTable.ajax.reload(null, false); //reload datatable ajax
        }
        $('#monitoringProjectMeetingTable').on("click", ".btnDelete", function() {
            ...
            if (result.value) {
                var url = "{{ route('monitoring-project-meeting/delete', ['id' => ':id']) }}";
