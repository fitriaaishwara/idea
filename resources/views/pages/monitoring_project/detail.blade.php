...
@section('title') @lang('Detail Project') @endsection
    ...
    <script type="text/javascript">
        ...
        var monitoringProjectDetailTable = $('#monitoringProjectDetailTable').DataTable({
            ...
            },
            {
                ...
                if (row.monitoring_project_detail_dates) {
                    ...
                    let no = key + 1;
                    let revise_date = moment(value.revise_date).format("DD MMMM YYYY");
                    detail += '<b>Revise ' + no + ' Plan Date</b><br>' + revise_date + '<br>' + value.revise_comment + '<br>';
                    });
                }
        ...
        function show(monitoring_project_id) {
            ...
            success: function(response) {
                ...
                let monitoring_client_id = (response.data.monitoring_client) ? new Option(response.data.monitoring_client.name, response.data.monitoring_client.id, true, true) : null;
