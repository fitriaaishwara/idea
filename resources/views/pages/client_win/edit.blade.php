...
@section('title') @lang('Edit Client') @endsection
    ...
    <div class="col-12">
        <div class="card">
                    ...
                    <div class="col-lg-6">
                        <div>
                            ...
                            <div class="mb-3 validate">
                                ...
                                <select id="province_id" type="text" class="form-control" id="province_id" name="province_id">
                                </select>
                            </div>
                            <div class="mb-3 validate">
                                <label for="regency_id" class="form-label">Regency<span style="color:red;">*</span></label>
                                <select id="regency_id" type="text" class="form-control" id="regency_id" name="regency_id">
                                </select>
                            </div>
                            <div class="mb-3 validate">
                    ...
                    <div class="col-lg-6">
                        <div class="mt-3 mt-lg-0">
                            ...
                            <div class="mb-3 validate">
                                ...
                                <input id="pic_position" type="text" class="form-control" name="pic_position">
                            </div>
                            <div class="mb-3 validate">
            ...
            <div class="card-footer">
                ...
                <a href="{{route('client-win')}}" class="btn btn-secondary waves-effect btn-sm" data-bs-dismiss="modal">Cancel</a>
            </div>
        </div>
    </div> <!-- end col -->
</div>
...
<script type="text/javascript">
  $(function(){
    ...
    $('#saveBtn').click(function(e) {
      ...
      if(isValid){
        let url = "{{route('client-win/edit',['id'=>':id'])}}";
        ...
        $.ajax({
          ...
          success: function(data)
          {
            ...
            (data.status)?window.location.href = "{{route('client-win')}}":"";
          },
          error: function (data)
          {
            Swal.fire(
