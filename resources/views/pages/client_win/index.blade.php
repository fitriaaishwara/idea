    ...
    <div id="clientWinModal" class="modal fade" tabindex="-1" aria-labelledby="clientWinModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-primary waves-effect waves-light btn-sm" id="clientWinBtn"
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Data Client Win</h3>
                </div>
                <div class="card-body">
    ...
    <script type="text/javascript">
        $(function() {
                ...
                "columns": [{
                    ...
                    @endif {
                        ...
                        render: function(data, type, row) {
                            ...
                            btnFollowUp += '<a href="/client-win/detail/follow-up/' + data +
                                '" type="button" class="btn btn-primary btn-sm m-1" data-toggle="tooltip" data-placement="top" title="Detail Follow Up"><i class="fa fa-list-ul"></i></a>';
                            btnDetail += '<a href="/client-win/detail/' + data +
                            ...
                            if ("{{ Auth::user()->can('Edit Client') }}") {
                                btnEdit += '<a href="/client-win/edit/' + data +
                            ...
                            return btnFollowUp + btnDetail + btnEdit + btnDelete;
                        },
                    },
                ]
            });
            ...
            $('#clientTable').on("click", ".btnFollowUp", function() {
                ...
                let url = "{{ route('client-win/show', ['id' => ':id']) }}";
            ...
            $('#clientTable').on("click", ".btnDelete", function() {
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        var url = "{{ route('client-win/delete', ['id' => ':id']) }}";
                        url = url.replace(':id', id);
                        $.ajax({
                            headers: {
            ...
            $('#followUpBtn').click(function(e) {
                ...
                if (isValid) {
                    let url = "{{ route('client-win/follow-up') }}";
            ...
            $('#btnApply').click(function() {
                ...
                request.scope_id = $("#filterScope").val();
                reloadTable();
            });
            $('#btnReset').on('click', function() {
                ...
                $("#filterScope").val('').trigger('change');
                reloadTable();
            })
